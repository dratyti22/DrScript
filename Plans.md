...
- [x] Поддержка ввода чисел и строк

## 2. Поддержка строк
- [x] Добавить тип `String` в AST и интерпретатор
- [x] Реализовать конкатенацию строк через оператор `+`
- [x] Поддержка строковых литералов в кавычках

## 3. Переписать под нормальный стиль
- [x] Добавить span'ы в AST для точных позиций ошибок
- [x] Улучшить обработку ошибок с правильными позициями
